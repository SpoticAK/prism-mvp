...
<style>
    ...
    .stButton>button, .stLinkButton>a {
        ...
        color: #1c1c1e !important; padding: 10px 24px; font-weight: 600;
...
def main():
    ...
    # Initialize session state for randomization
    ...
    st.markdown("<p style='text-align: center; margin-top: -10px; font-size: 1.1rem; color: #555;'>Product Research & Insight System</p>", unsafe_allow_html=True)
    ...
    with col2:
        with st.container():
            ...
            indiamart_url = generate_indiamart_link(current_product.get('Identified Item', 'N/A'))
