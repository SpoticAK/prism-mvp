...
def main():
    ...
    if 'app_loaded' not in st.session_state:
        ...
        # Shuffle for product browsing, never for saved sidebar (use original indices)
        ...
        try:
            ...
            # Save original DataFrame indices for persistence/stability
        ...
        # Main pointer always uses stable index
    ...
    with st.sidebar:
        ...
        if not st.session_state.saved_products:
            ...
            for saved_index in st.session_state.saved_products[:]:
                if saved_index not in df.index:  # Defensive: skip missing
                    continue
